<<<<<<< HEAD
TalentCoin (TLC) - a 'faster' version of Litecoin which also uses scrypt
...
So actually, this 'new' coin exists for the following reasons:
 - TLC proves that really anyone(!) can start a Litecoin/Bitcoin based currency
...
Finally, I only tested the command line server/tool 'talentcoin' for the
...
>>>>>>> 756faf34b09ba924ae6fc1fcf74be6fbce853c3e
