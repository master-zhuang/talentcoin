...
uint256 hashGenesisBlock("0x34a1d51782441e08b9e715e3eb46b45e1c6a3c4729782b285aa1331bfa327d98");
...
const string strMessageMagic = "TalentCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // TalentCoin: 0.35 days
static const int64 nTargetSpacing = 15; // TalentCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal talentcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TalentCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x34a1d51782441e08b9e715e3eb46b45e1c6a3c4729782b285aa1331bfa327d98");
    }
	...
	//  nTime=1407045178, nBits=1e0ffff0, nNonce=2085386442, vtx=1)
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "The talent coin ensures no premining took place";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x04dee42957fe7f369fe0830b1f3c070b6025ed58d157a519575d170c86e6ba02"));
